...
class NaArm9Functions:
    ...
    Svc_SoftReset = Symbol([0x566], [0x2000566], None, "Software interrupt.")

    Svc_WaitByLoop = Symbol([0x88], [0x2000088], None, "Software interrupt.")

    Svc_CpuSet = Symbol([0x78E], [0x200078E], None, "Software interrupt.")
...
class NaArm9Data:
    ...
    SCROLL_BOX_DEFAULT_WINDOW_PARAMS = Symbol(
        [0x9AF1C], [0x209AF1C], 0x10, "Default window_params for a scroll_box."
    )

    DIALOGUE_BOX_DEFAULT_WINDOW_PARAMS = Symbol(
        [0x9AF2C], [0x209AF2C], 0x10, "Default window_params for a dialogue_box."
    )
    ...
    TEXT_BOX_DEFAULT_WINDOW_PARAMS = Symbol(
        [0x9AF4C], [0x209AF4C], 0x10, "Default window_params for a text_box."
    )
    ...
    CONTROLS_CHART_DEFAULT_WINDOW_PARAMS = Symbol(
        [0x9AF78], [0x209AF78], 0x10, "Default window_params for a controls_chart."
    )

    ALERT_BOX_DEFAULT_WINDOW_PARAMS = Symbol(
        [0x9AF94], [0x209AF94], 0x10, "Default window_params for an alert_box."
    )
    ...
    LFO_OUTPUT_VOICE_UPDATE_FLAGS = Symbol([0xA9FA0], [0x20A9FA0], 0x10, "")
    ...
    TEX_PLTT_START_ADDR_TABLE = Symbol([0xAE0B4], [0x20AE0B4], 0x10, "")

    TEX_START_ADDR_TABLE = Symbol([0xAE0C4], [0x20AE0C4], 0x60, "")
    ...
    MISSION_DUNGEON_COUNT = Symbol(
        [0xB0A6C], [0x20B0A6C], 0x4, "The total number of dungeons usable for missions"
    )
    ...
    MISSION_MONSTER_COUNT = Symbol(
        [0xB0A74], [0x20B0A74], 0x4, "The total number of monsters usable for missions"
    )
    ...
    LFO_WAVEFORM_CALLBACKS = Symbol([0xB1250], [0x20B1250], 0x40, "")

    IS_DISP_ON = Symbol([0xB2B94], [0x20B2B94], 0x1, "")

    GXI_DMA_ID = Symbol([0xB2B98], [0x20B2B98], 0x4, "")
...
class NaLibsFunctions:
    ...
    DseDriver_Init = Symbol([0x308], [0x206C3E0], None, "")

    Dse_SetError = Symbol([0x77C], [0x206C854], None, "")

    Dse_SetError2 = Symbol([0x7B0], [0x206C888], None, "")

    DseUtil_ByteSwap32 = Symbol([0x7EC], [0x206C8C4], None, "")

    SoundUtil_GetRandomNumber = Symbol(
        [0x81C], [0x206C8F4], None, "return: random number in the range [0, 32767]"
    )

    DseMem_Init = Symbol([0x844], [0x206C91C], None, "")

    DseMem_Quit = Symbol([0x8B4], [0x206C98C], None, "")

    DseMem_AllocateUser = Symbol([0x8D0], [0x206C9A8], None, "")
    ...
    DseMem_Clear = Symbol([0xBE4], [0x206CCBC], None, "")
    ...
    DseSwd_GetNextSplitInRange = Symbol([0x14F0], [0x206D5C8], None, "")

    DseSwd_GetMainBankById = Symbol([0x1578], [0x206D650], None, "")

    DseSwd_GetBankById = Symbol([0x15C8], [0x206D6A0], None, "")

    DseSwd_InitMainBankFileReader = Symbol([0x1618], [0x206D6F0], None, "")

    DseSwd_OpenMainBankFileReader = Symbol([0x1628], [0x206D700], None, "")

    DseSwd_CloseMainBankFileReader = Symbol([0x1654], [0x206D72C], None, "")

    DseSwd_ReadMainBank = Symbol([0x1664], [0x206D73C], None, "")

    DseBgm_DefaultSignalCallback = Symbol([0x1728], [0x206D800], None, "")

    DseBgm_Load = Symbol([0x1730], [0x206D808], None, "")

    DseBgm_Unload = Symbol([0x1834], [0x206D90C], None, "")

    DseBgm_SetSignalCallback = Symbol([0x186C], [0x206D944], None, "")

    DseBgm_IsPlaying = Symbol([0x18CC], [0x206D9A4], None, "")
    ...
    DseBgm_Stop = Symbol([0x19C4], [0x206DA9C], None, "")

    DseBgm_StopAll = Symbol([0x1A04], [0x206DADC], None, "")

    DseBgm_SetFades = Symbol([0x1A64], [0x206DB3C], None, "")

    DseSequence_Start = Symbol([0x1AA4], [0x206DB7C], None, "")

    DseSequence_PauseList = Symbol([0x1B34], [0x206DC0C], None, "")
    ...
    DseSequence_LoadSong = Symbol([0x247C], [0x206E554], None, "")

    DseSequence_GetById = Symbol([0x257C], [0x206E654], None, "")

    DseSequence_AllocateNew = Symbol([0x25C8], [0x206E6A0], None, "")
    ...
    DseSe_Load = Symbol([0x2940], [0x206EA18], None, "")

    DseSe_Unload = Symbol([0x2AF4], [0x206EBCC], None, "")

    DseSe_GetUsedBankIDs = Symbol([0x2B84], [0x206EC5C], None, "")

    DseSe_HasPlayingInstances = Symbol([0x2C58], [0x206ED30], None, "")

    DseSe_Play = Symbol([0x2D24], [0x206EDFC], None, "")

    DseSe_GetEffectSong = Symbol([0x2ED8], [0x206EFB0], None, "")

    DseSe_CheckTooManyInstances = Symbol([0x2F20], [0x206EFF8], None, "")

    DseSe_CheckTooManyInstancesInGroup = Symbol([0x3028], [0x206F100], None, "")

    DseSe_GetBestSeqAllocation = Symbol([0x31EC], [0x206F2C4], None, "")

    DseSe_GetById = Symbol([0x3268], [0x206F340], None, "")

    DseSe_Stop = Symbol([0x32B4], [0x206F38C], None, "")

    DseSe_StopAll = Symbol([0x3408], [0x206F4E0], None, "")

    DseSe_StopSeq = Symbol([0x3474], [0x206F54C], None, "")

    FlushChannels = Symbol(
        [0x459C], [0x2070674], None, "Note: unverified, ported from Irdkwia's notes"
    )
    ...
    DseSequence_TickNotes = Symbol([0x5088], [0x2071160], None, "")
    ...
    DseSequence_TickFades = Symbol([0x56AC], [0x2071784], None, "")

    DseTrackEvent_Invalid = Symbol([0x5844], [0x207191C], None, "")

    DseTrackEvent_WaitSame = Symbol([0x5850], [0x2071928], None, "")

    DseTrackEvent_WaitDelta = Symbol([0x585C], [0x2071934], None, "")

    DseTrackEvent_Wait8 = Symbol([0x5874], [0x207194C], None, "")

    DseTrackEvent_Wait16 = Symbol([0x5884], [0x207195C], None, "")

    DseTrackEvent_Wait24 = Symbol([0x58A0], [0x2071978], None, "")

    DseTrackEvent_WaitUntilFadeout = Symbol([0x58C4], [0x207199C], None, "")

    DseTrackEvent_EndTrack = Symbol([0x58F0], [0x20719C8], None, "")

    DseTrackEvent_MainLoopBegin = Symbol([0x593C], [0x2071A14], None, "")

    DseTrackEvent_SubLoopBegin = Symbol([0x5944], [0x2071A1C], None, "")

    DseTrackEvent_SubLoopEnd = Symbol([0x5984], [0x2071A5C], None, "")

    DseTrackEvent_SubLoopBreakOnLastIteration = Symbol([0x59C0], [0x2071A98], None, "")

    DseTrackEvent_SetOctave = Symbol([0x59E8], [0x2071AC0], None, "")

    DseTrackEvent_OctaveDelta = Symbol([0x59F4], [0x2071ACC], None, "")

    DseTrackEvent_SetBpm = Symbol([0x5A08], [0x2071AE0], None, "")

    DseTrackEvent_SetBpm2 = Symbol([0x5A48], [0x2071B20], None, "")

    DseTrackEvent_SetBank = Symbol([0x5A88], [0x2071B60], None, "")

    DseTrackEvent_SetBankMsb = Symbol([0x5AB4], [0x2071B8C], None, "")

    DseTrackEvent_SetBankLsb = Symbol([0x5AE4], [0x2071BBC], None, "")

    DseTrackEvent_Dummy1Byte = Symbol([0x5B14], [0x2071BEC], None, "")

    DseTrackEvent_SetInstrument = Symbol([0x5B1C], [0x2071BF4], None, "")

    DseTrackEvent_SongVolumeFade = Symbol([0x5B64], [0x2071C3C], None, "")

    DseTrackEvent_RestoreEnvelopeDefaults = Symbol([0x5BF0], [0x2071CC8], None, "")

    DseTrackEvent_SetEnvelopeAttackBegin = Symbol([0x5C08], [0x2071CE0], None, "")

    DseTrackEvent_SetEnvelopeAttackTime = Symbol([0x5C28], [0x2071D00], None, "")

    DseTrackEvent_SetEnvelopeHoldTime = Symbol([0x5C48], [0x2071D20], None, "")

    DseTrackEvent_SetEnvelopeDecayTimeAndSustainLevel = Symbol(
        [0x5C68], [0x2071D40], None, ""
    )

    DseTrackEvent_SetEnvelopeSustainTime = Symbol([0x5C98], [0x2071D70], None, "")

    DseTrackEvent_SetEnvelopeReleaseTime = Symbol([0x5CB8], [0x2071D90], None, "")

    DseTrackEvent_SetNoteDurationMultiplier = Symbol([0x5CD8], [0x2071DB0], None, "")

    DseTrackEvent_ForceLfoEnvelopeLevel = Symbol([0x5CE4], [0x2071DBC], None, "")

    DseTrackEvent_SetHoldNotes = Symbol([0x5D00], [0x2071DD8], None, "")

    DseTrackEvent_SetFlagBit1Unknown = Symbol([0x5D38], [0x2071E10], None, "")

    DseTrackEvent_SetOptionalVolume = Symbol([0x5D48], [0x2071E20], None, "")

    DseTrackEvent_Dummy2Bytes = Symbol([0x5D54], [0x2071E2C], None, "")

    DseTrackEvent_SetTuning = Symbol([0x5D5C], [0x2071E34], None, "")

    DseTrackEvent_TuningDeltaCoarse = Symbol([0x5DDC], [0x2071EB4], None, "")

    DseTrackEvent_TuningDeltaFine = Symbol([0x5E64], [0x2071F3C], None, "")

    DseTrackEvent_TuningDeltaFull = Symbol([0x5EEC], [0x2071FC4], None, "")

    DseTrackEvent_TuningFade = Symbol([0x5F7C], [0x2072054], None, "")

    DseTrackEvent_SetNoteRandomRegion = Symbol([0x606C], [0x2072144], None, "")

    DseTrackEvent_SetTuningJitterAmplitude = Symbol([0x6094], [0x207216C], None, "")

    DseTrackEvent_SetKeyBend = Symbol([0x60AC], [0x2072184], None, "")

    DseTrackEvent_SetUnknown2 = Symbol([0x60D8], [0x20721B0], None, "")

    DseTrackEvent_SetKeyBendRange = Symbol([0x60F0], [0x20721C8], None, "")

    DseTrackEvent_SetupKeyBendLfo = Symbol([0x60FC], [0x20721D4], None, "")

    DseTrackEvent_SetupKeyBendLfoEnvelope = Symbol([0x6154], [0x207222C], None, "")

    DseTrackEvent_UseKeyBendLfo = Symbol([0x617C], [0x2072254], None, "")

    DseTrackEvent_SetVolume = Symbol([0x61A4], [0x207227C], None, "")

    DseTrackEvent_VolumeDelta = Symbol([0x6238], [0x2072310], None, "")

    DseTrackEvent_VolumeFade = Symbol([0x62E8], [0x20723C0], None, "")

    DseTrackEvent_SetExpression = Symbol([0x6344], [0x207241C], None, "")

    DseTrackEvent_SetupVolumeLfo = Symbol([0x63D0], [0x20724A8], None, "")

    DseTrackEvent_SetupVolumeLfoEnvelope = Symbol([0x642C], [0x2072504], None, "")

    DseTrackEvent_UseVolumeLfo = Symbol([0x6454], [0x207252C], None, "")

    DseTrackEvent_SetPan = Symbol([0x647C], [0x2072554], None, "")

    DseTrackEvent_PanDelta = Symbol([0x64FC], [0x20725D4], None, "")

    DseTrackEvent_PanFade = Symbol([0x6590], [0x2072668], None, "")

    DseTrackEvent_SetupPanLfo = Symbol([0x65EC], [0x20726C4], None, "")

    DseTrackEvent_SetupPanLfoEnvelope = Symbol([0x6648], [0x2072720], None, "")

    DseTrackEvent_UsePanLfo = Symbol([0x6670], [0x2072748], None, "")

    DseTrackEvent_SetupLfo = Symbol([0x6698], [0x2072770], None, "")

    DseTrackEvent_SetupLfoEnvelope = Symbol([0x66F0], [0x20727C8], None, "")

    DseTrackEvent_SetLfoParameter = Symbol([0x6724], [0x20727FC], None, "")

    DseTrackEvent_UseLfo = Symbol([0x6860], [0x2072938], None, "")

    DseTrackEvent_Signal = Symbol([0x6894], [0x207296C], None, "")

    DseTrackEvent_Dummy2Bytes2 = Symbol([0x68C4], [0x207299C], None, "")

    DseSynth_Reset = Symbol([0x7130], [0x2073208], None, "")

    DseSynth_AllocateNew = Symbol([0x71A8], [0x2073280], None, "")

    DseSynth_Unload = Symbol([0x7278], [0x2073350], None, "")

    DseSynth_ClearHeldNotes = Symbol([0x72E4], [0x20733BC], None, "")

    DseSynth_ResetAndSetBankAndSequence = Symbol([0x7380], [0x2073458], None, "")

    DseSynth_StopChannels = Symbol([0x73A8], [0x2073480], None, "")

    DseSynth_ResetAllVoiceTimersAndVolumes = Symbol([0x73D4], [0x20734AC], None, "")

    DseSynth_RestoreHeldNotes = Symbol([0x742C], [0x2073504], None, "")

    DseSynth_SetGlobalVolumeIndex = Symbol([0x7494], [0x207356C], None, "")

    DseSynth_SetBend = Symbol([0x757C], [0x2073654], None, "")

    DseSynth_SetVolume = Symbol([0x7610], [0x20736E8], None, "")

    DseSynth_SetPan = Symbol([0x76E0], [0x20737B8], None, "")

    DseSynth_SetBankAndSequence = Symbol([0x7774], [0x207384C], None, "")

    DseChannel_Init = Symbol([0x7804], [0x20738DC], None, "")

    DseChannel_DeallocateVoices = Symbol([0x79B8], [0x2073A90], None, "")

    DseChannel_ResetTimerAndVolumeForVoices = Symbol([0x7A3C], [0x2073B14], None, "")

    DseChannel_SetBank = Symbol([0x7AB8], [0x2073B90], None, "")

    DseChannel_SetInstrument = Symbol([0x7AF0], [0x2073BC8], None, "")

    DseChannel_SetLfoConstEnvelopeLevel = Symbol([0x7B84], [0x2073C5C], None, "")

    DseChannel_SetKeyBend = Symbol([0x7BB8], [0x2073C90], None, "")
    ...
    DseVoice_ReleaseNote = Symbol([0x8078], [0x2074150], None, "")

    DseVoice_UpdateParameters = Symbol([0x80BC], [0x2074194], None, "")

    DseVoice_ResetAll = Symbol([0x8260], [0x2074338], None, "")

    DseVoice_ResetHW = Symbol([0x8304], [0x20743DC], None, "")
    ...
    DseVoice_Cleanup = Symbol([0x84A4], [0x207457C], None, "")

    DseVoice_Allocate = Symbol([0x8540], [0x2074618], None, "")

    DseVoice_Start = Symbol([0x86A8], [0x2074780], None, "")

    DseVoice_ReleaseHeld = Symbol([0x8704], [0x20747DC], None, "")

    DseVoice_Release = Symbol([0x8784], [0x207485C], None, "")

    DseVoice_Deallocate = Symbol([0x87C8], [0x20748A0], None, "")

    DseVoice_FlagForActivation = Symbol([0x88CC], [0x20749A4], None, "")

    DseVoice_FlagForDeactivation = Symbol([0x891C], [0x20749F4], None, "")

    DseVoice_CountNumActiveInChannel = Symbol([0x8954], [0x2074A2C], None, "")

    DseVoice_UpdateHardware = Symbol([0x8980], [0x2074A58], None, "")
    ...
    Mtx_OrthoW = Symbol([0x9858], [0x2075930], None, "")

    FX_Div = Symbol([0x9A60], [0x2075B38], None, "")

    FX_GetDivResultFx64c = Symbol([0x9A70], [0x2075B48], None, "")

    FX_GetDivResult = Symbol([0x9A94], [0x2075B6C], None, "")

    FX_InvAsync = Symbol([0x9ACC], [0x2075BA4], None, "")

    FX_DivAsync = Symbol([0x9AFC], [0x2075BD4], None, "")

    FX_DivS32 = Symbol([0x9B24], [0x2075BFC], None, "")

    FX_ModS32 = Symbol([0x9B60], [0x2075C38], None, "")

    Vec_DotProduct = Symbol([0x9B9C], [0x2075C74], None, "")

    Vec_CrossProduct = Symbol([0x9BD8], [0x2075CB0], None, "")

    Vec_Normalize = Symbol([0x9C5C], [0x2075D34], None, "")

    Vec_Distance = Symbol([0x9D74], [0x2075E4C], None, "")

    FX_Atan2Idx = Symbol([0x9DF0], [0x2075EC8], None, "")

    GX_Init = Symbol([0x9F9C], [0x2076074], None, "")

    GX_HBlankIntr = Symbol([0xA0E8], [0x20761C0], None, "")

    GX_VBlankIntr = Symbol([0xA110], [0x20761E8], None, "")

    GX_DispOff = Symbol([0xA144], [0x207621C], None, "")

    GX_DispOn = Symbol([0xA180], [0x2076258], None, "")

    GX_SetGraphicsMode = Symbol([0xA1C8], [0x20762A0], None, "")

    Gxs_SetGraphicsMode = Symbol([0xA230], [0x2076308], None, "")

    GXx_SetMasterBrightness = Symbol([0xA24C], [0x2076324], None, "")

    GX_InitGxState = Symbol([0xA274], [0x207634C], None, "")
    ...
    GX_SetBankForBg = Symbol([0xA38C], [0x2076464], None, "")

    GX_SetBankForObj = Symbol([0xA61C], [0x20766F4], None, "")

    GX_SetBankForBgExtPltt = Symbol([0xA76C], [0x2076844], None, "")

    GX_SetBankForObjExtPltt = Symbol([0xA86C], [0x2076944], None, "")

    GX_SetBankForTex = Symbol([0xA918], [0x20769F0], None, "")

    GX_SetBankForTexPltt = Symbol([0xAAF0], [0x2076BC8], None, "")

    GX_SetBankForClearImage = Symbol([0xABD8], [0x2076CB0], None, "")

    GX_SetBankForArm7 = Symbol([0xAD0C], [0x2076DE4], None, "")

    GX_SetBankForLcdc = Symbol([0xADB8], [0x2076E90], None, "")

    GX_SetBankForSubBg = Symbol([0xADD8], [0x2076EB0], None, "")

    GX_SetBankForSubObj = Symbol([0xAE80], [0x2076F58], None, "")

    GX_SetBankForSubBgExtPltt = Symbol([0xAEF0], [0x2076FC8], None, "")

    GX_SetBankForSubObjExtPltt = Symbol([0xAF70], [0x2077048], None, "")
    ...
    GX_ResetBankForBgExtPltt = Symbol([0xB024], [0x20770FC], None, "")

    GX_ResetBankForObjExtPltt = Symbol([0xB048], [0x2077120], None, "")

    GX_ResetBankForTex = Symbol([0xB06C], [0x2077144], None, "")

    GX_ResetBankForTexPltt = Symbol([0xB080], [0x2077158], None, "")

    GX_ResetBankForSubBgExtPltt = Symbol([0xB094], [0x207716C], None, "")

    GX_ResetBankForSubObjExtPltt = Symbol([0xB0BC], [0x2077194], None, "")

    DisableBankForX = Symbol([0xB0E4], [0x20771BC], None, "")

    GX_DisableBankForBg = Symbol([0xB1C4], [0x207729C], None, "")

    GX_DisableBankForObj = Symbol([0xB1D8], [0x20772B0], None, "")

    GX_DisableBankForBgExtPltt = Symbol([0xB1EC], [0x20772C4], None, "")

    GX_DisableBankForObjExtPltt = Symbol([0xB210], [0x20772E8], None, "")

    GX_DisableBankForTex = Symbol([0xB234], [0x207730C], None, "")

    GX_DisableBankForTexPltt = Symbol([0xB248], [0x2077320], None, "")

    GX_DisableBankForClearImage = Symbol([0xB25C], [0x2077334], None, "")

    GX_DisableBankForArm7 = Symbol([0xB270], [0x2077348], None, "")

    GX_DisableBankForLcdc = Symbol([0xB284], [0x207735C], None, "")

    GX_DisableBankForSubBg = Symbol([0xB298], [0x2077370], None, "")

    GX_DisableBankForSubObj = Symbol([0xB2AC], [0x2077384], None, "")

    GX_DisableBankForSubBgExtPltt = Symbol([0xB2C0], [0x2077398], None, "")

    GX_DisableBankForSubObjExtPltt = Symbol([0xB2E8], [0x20773C0], None, "")

    G2_GetBG0ScrPtr = Symbol([0xB310], [0x20773E8], None, "")

    G2S_GetBG0ScrPtr = Symbol([0xB344], [0x207741C], None, "")

    G2_GetBG1ScrPtr = Symbol([0xB364], [0x207743C], None, "")

    G2S_GetBG1ScrPtr = Symbol([0xB398], [0x2077470], None, "")

    G2_GetBG2ScrPtr = Symbol([0xB3B8], [0x2077490], None, "")

    G2_GetBG3ScrPtr = Symbol([0xB43C], [0x2077514], None, "")

    G2_GetBG0CharPtr = Symbol([0xB4C0], [0x2077598], None, "")

    G2S_GetBG0CharPtr = Symbol([0xB4F4], [0x20775CC], None, "")

    G2_GetBG1CharPtr = Symbol([0xB514], [0x20775EC], None, "")

    G2S_GetBG1CharPtr = Symbol([0xB548], [0x2077620], None, "")

    G2_GetBG2CharPtr = Symbol([0xB568], [0x2077640], None, "")

    G2_GetBG3CharPtr = Symbol([0xB5B8], [0x2077690], None, "")

    G2x_SetBlendAlpha = Symbol([0xB610], [0x20776E8], None, "")

    G2x_SetBlendBrightness = Symbol([0xB62C], [0x2077704], None, "")

    G2x_ChangeBlendBrightness = Symbol([0xB654], [0x207772C], None, "")

    G3_LoadMtx44 = Symbol([0xB698], [0x2077770], None, "")
    ...
    G3X_Init = Symbol([0xB6EC], [0x20777C4], None, "")

    G3X_Reset = Symbol([0xB7F8], [0x20778D0], None, "")

    G3X_ClearFifo = Symbol([0xB864], [0x207793C], None, "")

    G3X_InitMtxStack = Symbol([0xB88C], [0x2077964], None, "")

    G3X_ResetMtxStack = Symbol([0xB924], [0x20779FC], None, "")

    G3X_SetClearColor = Symbol([0xB9B4], [0x2077A8C], None, "")

    G3X_InitTable = Symbol([0xB9DC], [0x2077AB4], None, "")

    G3X_GetMtxStackLevelPV = Symbol([0xBA7C], [0x2077B54], None, "")

    G3X_GetMtxStackLevelPJ = Symbol([0xBAAC], [0x2077B84], None, "")

    GXi_NopClearFifo128 = Symbol([0xBADC], [0x2077BB4], None, "")

    G3i_OrthoW = Symbol([0xBB70], [0x2077C48], None, "")

    G3i_LookAt = Symbol([0xBBD4], [0x2077CAC], None, "")

    GX_LoadBgPltt = Symbol([0xBC20], [0x2077CF8], None, "")

    Gxs_LoadBgPltt = Symbol([0xBC74], [0x2077D4C], None, "")

    GX_LoadObjPltt = Symbol([0xBCCC], [0x2077DA4], None, "")

    Gxs_LoadObjPltt = Symbol([0xBD24], [0x2077DFC], None, "")

    GX_LoadOam = Symbol([0xBD7C], [0x2077E54], None, "")

    Gxs_LoadOam = Symbol([0xBDD0], [0x2077EA8], None, "")

    GX_LoadObj = Symbol([0xBE28], [0x2077F00], None, "")

    Gxs_LoadObj = Symbol([0xBE80], [0x2077F58], None, "")

    GX_LoadBg0Scr = Symbol([0xBED8], [0x2077FB0], None, "")

    GX_LoadBg1Scr = Symbol([0xBF38], [0x2078010], None, "")

    Gxs_LoadBg1Scr = Symbol([0xBF98], [0x2078070], None, "")

    GX_LoadBg2Scr = Symbol([0xBFF8], [0x20780D0], None, "")

    GX_LoadBg3Scr = Symbol([0xC058], [0x2078130], None, "")

    GX_LoadBg0Char = Symbol([0xC0B8], [0x2078190], None, "")

    Gxs_LoadBg0Char = Symbol([0xC118], [0x20781F0], None, "")

    GX_LoadBg1Char = Symbol([0xC178], [0x2078250], None, "")

    Gxs_LoadBg1Char = Symbol([0xC1D8], [0x20782B0], None, "")

    GX_LoadBg2Char = Symbol([0xC238], [0x2078310], None, "")

    GX_LoadBg3Char = Symbol([0xC298], [0x2078370], None, "")

    GX_BeginLoadBgExtPltt = Symbol([0xC2F8], [0x20783D0], None, "")

    GX_EndLoadBgExtPltt = Symbol([0xC398], [0x2078470], None, "")

    GX_BeginLoadObjExtPltt = Symbol([0xC3E0], [0x20784B8], None, "")

    GX_EndLoadObjExtPltt = Symbol([0xC428], [0x2078500], None, "")

    Gxs_BeginLoadBgExtPltt = Symbol([0xC46C], [0x2078544], None, "")

    Gxs_EndLoadBgExtPltt = Symbol([0xC484], [0x207855C], None, "")

    Gxs_BeginLoadObjExtPltt = Symbol([0xC4C4], [0x207859C], None, "")

    Gxs_EndLoadObjExtPltt = Symbol([0xC4DC], [0x20785B4], None, "")

    GX_BeginLoadTex = Symbol([0xC51C], [0x20785F4], None, "")

    GX_LoadTex = Symbol([0xC578], [0x2078650], None, "")

    GX_EndLoadTex = Symbol([0xC6B8], [0x2078790], None, "")

    GX_BeginLoadTexPltt = Symbol([0xC704], [0x20787DC], None, "")

    GX_LoadTexPltt = Symbol([0xC738], [0x2078810], None, "")

    GX_EndLoadTexPltt = Symbol([0xC7A4], [0x207887C], None, "")
    ...
    GX_SendFifo64B = Symbol([0xC80C], [0x20788E4], None, "")

    OS_GetLockID = Symbol([0xCF54], [0x207902C], None, "")
...
class NaOverlay11Data:
    ...
    TEAM_INFO_BOX_DEFAULT_WINDOW_PARAMS = Symbol(
        [0x4621C], [0x232245C], 0x10, "Default window_params for a team_info_box."
    )
...
class NaOverlay14Data:
    ...
    SENTRY_DEBUG_MENU_ITEMS = Symbol([0x3960], [0x238DAA0], 0x48, "")
...
class NaOverlay16Data:
    ...
    EVO_MAIN_MENU_ITEMS = Symbol([0x2C00], [0x238CD40], 0x20, "")
...
class NaOverlay17Data:
    ...
    ASSEMBLY_MENU_ITEMS_CONFIRM = Symbol([0x1A44], [0x238BB84], 0x18, "")

    ASSEMBLY_MAIN_MENU_ITEMS_1 = Symbol([0x1A5C], [0x238BB9C], 0x18, "")

    ASSEMBLY_MAIN_MENU_ITEMS_2 = Symbol([0x1A74], [0x238BBB4], 0x20, "")

    ASSEMBLY_SUBMENU_ITEMS_1 = Symbol([0x1A94], [0x238BBD4], 0x28, "")

    ASSEMBLY_SUBMENU_ITEMS_2 = Symbol([0x1ABC], [0x238BBFC], 0x30, "")

    ASSEMBLY_SUBMENU_ITEMS_3 = Symbol([0x1AEC], [0x238BC2C], 0x30, "")

    ASSEMBLY_SUBMENU_ITEMS_4 = Symbol([0x1B1C], [0x238BC5C], 0x38, "")

    ASSEMBLY_SUBMENU_ITEMS_5 = Symbol([0x1B54], [0x238BC94], 0x38, "")

    ASSEMBLY_SUBMENU_ITEMS_6 = Symbol([0x1B8C], [0x238BCCC], 0x38, "")

    ASSEMBLY_SUBMENU_ITEMS_7 = Symbol([0x1BC4], [0x238BD04], 0x40, "")
...
class NaOverlay18Data:
    ...
    LINK_SHOP_MENU_ITEMS_CONFIRM = Symbol([0x31E0], [0x238D320], 0x18, "")

    LINK_SHOP_SUBMENU_ITEMS_1 = Symbol([0x31F8], [0x238D338], 0x20, "")

    LINK_SHOP_SUBMENU_ITEMS_2 = Symbol([0x3218], [0x238D358], 0x20, "")

    LINK_SHOP_MAIN_MENU_ITEMS = Symbol([0x3238], [0x238D378], 0x20, "")

    LINK_SHOP_SUBMENU_ITEMS_3 = Symbol([0x3258], [0x238D398], 0x28, "")

    LINK_SHOP_SUBMENU_ITEMS_4 = Symbol([0x3280], [0x238D3C0], 0x30, "")

    LINK_SHOP_SUBMENU_ITEMS_5 = Symbol([0x32B0], [0x238D3F0], 0x48, "")

    LINK_SHOP_SUBMENU_ITEMS_6 = Symbol([0x32F8], [0x238D438], 0x48, "")

    LINK_SHOP_SUBMENU_ITEMS_7 = Symbol([0x3340], [0x238D480], 0x48, "")
...
class NaOverlay19Data:
    ...
    BAR_MENU_ITEMS_CONFIRM_1 = Symbol([0x40C8], [0x238E208], 0x18, "")

    BAR_MENU_ITEMS_CONFIRM_2 = Symbol([0x40E0], [0x238E220], 0x18, "")

    OVERLAY19_UNKNOWN_STRING_IDS__NA_238E238 = Symbol(
        [0x40F8], [0x238E238], 0x18, "Note: unverified, ported from Irdkwia's notes"
    )

    BAR_MAIN_MENU_ITEMS = Symbol([0x4110], [0x238E250], 0x20, "")

    BAR_SUBMENU_ITEMS_1 = Symbol([0x4130], [0x238E270], 0x20, "")

    BAR_SUBMENU_ITEMS_2 = Symbol([0x4150], [0x238E290], 0x30, "")
...
class NaOverlay20Data:
    ...
    RECYCLE_MENU_ITEMS_CONFIRM_1 = Symbol([0x2E44], [0x238CF84], 0x18, "")

    RECYCLE_MENU_ITEMS_CONFIRM_2 = Symbol([0x2E5C], [0x238CF9C], 0x18, "")

    RECYCLE_SUBMENU_ITEMS_1 = Symbol([0x2E74], [0x238CFB4], 0x18, "")

    RECYCLE_SUBMENU_ITEMS_2 = Symbol([0x2E8C], [0x238CFCC], 0x20, "")

    RECYCLE_MAIN_MENU_ITEMS_1 = Symbol([0x2EAC], [0x238CFEC], 0x28, "")
    ...
    RECYCLE_MAIN_MENU_ITEMS_2 = Symbol([0x2F48], [0x238D088], 0x20, "")
    ...
    RECYCLE_MAIN_MENU_ITEMS_3 = Symbol([0x2FB8], [0x238D0F8], 0x18, "")
...
class NaOverlay21Data:
    ...
    SWAP_SHOP_MENU_ITEMS_CONFIRM = Symbol([0x28F8], [0x238CA38], 0x18, "")

    SWAP_SHOP_SUBMENU_ITEMS_1 = Symbol([0x2910], [0x238CA50], 0x18, "")

    SWAP_SHOP_SUBMENU_ITEMS_2 = Symbol([0x2928], [0x238CA68], 0x20, "")

    SWAP_SHOP_MAIN_MENU_ITEMS_1 = Symbol([0x2948], [0x238CA88], 0x20, "")

    SWAP_SHOP_MAIN_MENU_ITEMS_2 = Symbol([0x2968], [0x238CAA8], 0x28, "")

    SWAP_SHOP_SUBMENU_ITEMS_3 = Symbol([0x2990], [0x238CAD0], 0x30, "")
...
class NaOverlay22Data:
    ...
    SHOP_MENU_ITEMS_CONFIRM = Symbol([0x4728], [0x238E868], 0x18, "")

    SHOP_MAIN_MENU_ITEMS_1 = Symbol([0x4740], [0x238E880], 0x20, "")

    SHOP_MAIN_MENU_ITEMS_2 = Symbol([0x4760], [0x238E8A0], 0x20, "")

    SHOP_MAIN_MENU_ITEMS_3 = Symbol([0x4780], [0x238E8C0], 0x30, "")
...
class NaOverlay23Data:
    ...
    STORAGE_MENU_ITEMS_CONFIRM = Symbol([0x31BC], [0x238D2FC], 0x18, "")

    STORAGE_MAIN_MENU_ITEMS_1 = Symbol([0x31D4], [0x238D314], 0x20, "")

    STORAGE_MAIN_MENU_ITEMS_2 = Symbol([0x31F4], [0x238D334], 0x20, "")

    STORAGE_MAIN_MENU_ITEMS_3 = Symbol([0x3214], [0x238D354], 0x20, "")

    STORAGE_MAIN_MENU_ITEMS_4 = Symbol([0x3234], [0x238D374], 0x28, "")
...
class NaOverlay24Data:
    ...
    DAYCARE_MENU_ITEMS_CONFIRM = Symbol([0x23E0], [0x238C520], 0x18, "")

    DAYCARE_MAIN_MENU_ITEMS = Symbol([0x23F8], [0x238C538], 0x20, "")
...
class NaOverlay25Data:
    ...
    APPRAISAL_MENU_ITEMS_CONFIRM = Symbol([0x1374], [0x238B4B4], 0x18, "")

    APPRAISAL_MAIN_MENU_ITEMS = Symbol([0x138C], [0x238B4CC], 0x20, "")

    APPRAISAL_SUBMENU_ITEMS = Symbol([0x13AC], [0x238B4EC], 0x20, "")
...
class NaOverlay27Data:
    ...
    DISCARD_ITEMS_MENU_ITEMS_CONFIRM = Symbol([0x281C], [0x238C95C], 0x18, "")

    DISCARD_ITEMS_SUBMENU_ITEMS_1 = Symbol([0x2834], [0x238C974], 0x20, "")

    DISCARD_ITEMS_SUBMENU_ITEMS_2 = Symbol([0x2854], [0x238C994], 0x20, "")

    DISCARD_ITEMS_MAIN_MENU_ITEMS = Symbol([0x2874], [0x238C9B4], 0x28, "")
...
class NaOverlay31Data:
    ...
    DUNGEON_MAIN_MENU_ITEMS = Symbol([0x75B4], [0x2389DD4], 0x40, "")
    ...
    DUNGEON_SUBMENU_ITEMS_1 = Symbol([0x7650], [0x2389E70], 0x20, "")

    DUNGEON_SUBMENU_ITEMS_2 = Symbol([0x7670], [0x2389E90], 0x20, "")

    DUNGEON_SUBMENU_ITEMS_3 = Symbol([0x7690], [0x2389EB0], 0x20, "")

    DUNGEON_SUBMENU_ITEMS_4 = Symbol([0x76B0], [0x2389ED0], 0x20, "")
    ...
    DUNGEON_SUBMENU_ITEMS_5 = Symbol([0x78FC], [0x238A11C], 0x18, "")
    ...
    DUNGEON_SUBMENU_ITEMS_6 = Symbol([0x7980], [0x238A1A0], 0x48, "")
...
class NaOverlay34Data:
    ...
    START_MENU_ITEMS_CONFIRM = Symbol([0xDE4], [0x22DD024], 0x18, "")
    ...
    DUNGEON_DEBUG_MENU_ITEMS = Symbol([0xE0C], [0x22DD04C], 0x28, "")
...
class NaRamData:
    ...
    DISP_MODE = Symbol([0x2B9588], [0x22B9588], 0x2, "")

    GXI_VRAM_LOCK_ID = Symbol([0x2B958A], [0x22B958A], 0x2, "")
    ...
    SUB_BG_EXT_PLTT = Symbol([0x2B95A8], [0x22B95A8], 0x4, "")

    CLR_IMG = Symbol([0x2B95C4], [0x22B95C4], 0x4, "")
