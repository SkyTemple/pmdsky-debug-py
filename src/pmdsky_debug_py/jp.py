...
class JpArm9Data:
    ...
    MISSION_DUNGEON_COUNT = Symbol(
        [0xB22E0], [0x20B22E0], 0x4, "The total number of dungeons usable for missions"
    )
    ...
    MISSION_MONSTER_COUNT = Symbol(
        [0xB22E8], [0x20B22E8], 0x4, "The total number of monsters usable for missions"
    )
...
class JpLibsSection:
    ...
    loadaddress = 0x206C3C0
    length = 0x247FC
    functions = JpLibsFunctions
    data = JpLibsData
